...
// ║  Source: Final reconciliation + SUM009                       ║
// ║  Status: TOUR COMPLETE — ALL FUNDS TRANSFERRED              ║
// ╚══════════════════════════════════════════════════════════════╝
...
export const DATA = {
  ...
  palmBeach: {
    ...
    buyers: [
      ...
      { name: "Elin Mellanmyr", tickets: 1, amount: 220, date: "25/04", fee: 5.14 },
      { name: "Joy Wayne", tickets: 1, amount: 220, date: "25/04", fee: 5.14 },
      ...
      { name: "Gina Zeitlin", tickets: 2, amount: 440, date: "26/04", fee: 15.40 },
  ...
  miami: {
    ...
    buyers: [
      ...
      { name: "Carmen Chumaceiro", tickets: 1, amount: 450, date: "26/04", fee: 15.75 },
      { name: "Saskia Weidenhammer", tickets: 1, amount: 450, date: "26/04", fee: 10.20 },
      { name: "Paige Genen", tickets: 1, amount: 450, date: "26/04", fee: 15.75 },
      { name: "Daniel Beyda", tickets: 2, amount: 900, date: "26/04", fee: 31.50 },
      { name: "Clemence Rasigni", tickets: 2, amount: 900, date: "26/04", fee: 20.10 },
      { name: "Gabriel Nakash", tickets: 1, amount: 450, date: "26/04", fee: 10.20 },
      { name: "H C Bakken", tickets: 1, amount: 450, date: "26/04", fee: 10.20 },
      { name: "Chloe Kimel", tickets: 2, amount: 900, date: "26/04", fee: 20.10 },
      { name: "Saddy Delgado", tickets: 1, amount: 450, date: "26/04", fee: 10.20 },
      { name: "Daniel E Perez", tickets: 1, amount: 450, date: "26/04", fee: 10.20 },
      { name: "Adam Frank", tickets: 1, amount: 450, date: "26/04", fee: 10.20 },
    ],
  },
  ...
  transfers: [
    ...
    { ref: "SUM009", amount: 2933.45, gbp: 2170.75, rate: 0.74, date: "01/05/2026" },
  ],
};
